...
modelsize.repair = data.frame(Scenario = "Batch", Artifact = 2^(0:14), Triples = c("5k", "9k", "20k", "45k", "85k", "191k", "372k", "751k", "1.5M", "2.9M", "5.8M", "11.5M", "23.2M", "46.4M", "92.8M"))
modelsizes = do.call(rbind, list(modelsize.repair))
