...
ggplot(data=df, aes(x=Tool, y=Value, fill=Phase)) +
  ...
  labs(title = "Total execution time on model 'Qwicap'", x = "algorithm", y = "execution time [s]") +
  ggsave("diagrams/qwicap_resized.pdf", width=210, height=94, units="mm")
